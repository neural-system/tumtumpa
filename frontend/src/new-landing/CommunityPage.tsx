...
import { Arrow, AuthAwareLink, FlowFooter, FlowNav } from "./landing-components";
  ...
  return <main className="mural-page new-landing">
    ...
    <section className="mural-hero" aria-labelledby="mural-title">
      <div className="mural-hero-copy">
        ...
        <div className="mural-actions"><Link className="yellow-link" to="/mural">Encontrar músicos e bandas <Arrow direction="right" /></Link><AuthAwareLink className="mural-secondary-link" to="/mural/meus-anuncios">Criar meu anúncio <Arrow /></AuthAwareLink></div>
        <p className="mural-access-note">Explore os anúncios sem entrar. Para publicar, acesse sua conta.</p>
      </div>
      <CommunityPreview uniformPostHeight />
    </section>
    ...
    <section className="mural-alert-section" aria-labelledby="alerts-title">
      ...
      <div className="mural-alert-copy"><span className="section-kicker">AVISOS NO APLICATIVO</span><h2 id="alerts-title">A próxima vaga<br /><em>pode encontrar você.</em></h2><p>Preencha sua cidade e seus instrumentos no perfil. Quando uma banda da mesma cidade procurar alguém que toque seu instrumento, o aviso aparece no TumTumPá.</p><ul><li><CheckIcon />Vagas da sua cidade</li><li><CheckIcon />Compatibilidade com seus instrumentos</li></ul><Link className="mural-secondary-link" to="/login">Entrar e completar meu perfil <Arrow /></Link></div>
    </section>
    <section className="mural-final" aria-labelledby="ready-title"><div><span className="section-kicker">MONTE SUA BANDA</span><h2 id="ready-title">Vamos encontrar<br /><em>com quem tocar?</em></h2></div><div><p>Seu anúncio pode ser o começo da próxima formação.</p><AuthAwareLink className="yellow-link" to="/mural/meus-anuncios">Criar meu anúncio <Arrow /></AuthAwareLink><Link className="mural-secondary-link" to="/mural">Ver anúncios no mural <Arrow direction="right" /></Link></div></section>
    <FlowFooter />
  </main>;
}
